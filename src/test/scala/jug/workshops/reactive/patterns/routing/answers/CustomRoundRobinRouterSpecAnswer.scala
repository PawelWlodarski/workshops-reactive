...
import jug.workshops.reactive.patterns.routing.answers.CustomRoundRobinRouterAnswer.{CustomRouter, CustomWorker, Cycle, RoutedJob}
import org.scalatest.{MustMatchers, WordSpecLike}

import scala.collection.immutable.{IndexedSeq, Seq}

class CustomRoundRobinRouterSpecAnswer extends TestKit(ActorSystem("customRouter"))
